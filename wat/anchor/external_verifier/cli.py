...
The default ``--output-format`` is JSON because the original audit contract was JSON-pipeable to ``jq``; the text mode is for
...
from wat.anchor.external_verifier.poles import (

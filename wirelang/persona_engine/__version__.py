...
``ENGINE_VERSION`` from here. The 0.5.3-rc1 bump factored the
...
target to assert against. (this bump) promotes the RC to
...
(2026-05-19) — Final-Bump Pre-Cutover-Sealing.
``0.5.3`` is the **rc1-suffix-drop** of ``0.5.3-rc1``
(PR #372). It is a strict superset of ``0.5.3-rc1`` and a strict
superset of ``0.5.2-final-pre-cutover`` (PR #335) with the
OPEN-K1/K2/J1 closeouts absorbed as carry-forward
acknowledgements and the G5-PRE-CUTOVER-READY compositum
...
Scope discipline (the persona-engine side, ADR-0036/0043/0065/0066): this file
documents the engine version. It does **not** modify persona
definitions (HR-Domäne), WAT-core logic (WAT-Domäne, Zone-K),
identity-substrate design (protocol-Domäne, Zone-L), or container-infra
beyond label-level coordination (infra-Domäne, Zone-J).
"""

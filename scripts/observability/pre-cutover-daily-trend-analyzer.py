...
"""Phase-3c Pre-Cutover Daily-Trend-Analyzer.

Context
-------

 shipped the Pre-Cutover-Probe-Phase Live-Demo
...
promotes that single-shot driver into an *autonomous daily
trend tracker* for the ~3-week pre--Cutover window
...
* Pre-Cutover-Probe-Phase Live-Demo.
* (sister) — Marathon-Dashboard CI workflow.
...
class DailyEnvelope:
    ...
    , but kept as a thin dataclass here so

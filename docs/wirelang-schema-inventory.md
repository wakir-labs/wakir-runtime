...
| 5 | `wirelang/schemas/datalog-caveat.json`              | `https://wakir.dev/wirelang/schema/datalog-caveat/0.2.0`                       | 2020-12   | array  | Datalog-caveat array (Wakir Phase-1b vocabulary v0.2; Phase-2 ratified, Tag-15).      |

...
`infra/spire/agent/`. Each BSL unit has its own Change Date because
they were first BSL-published on different dates. The
`infra/spire/federation/` unit shares its Change Date with the
other Phase-2-Federation-BSL units activated under ADR-0059 on
2026-05-13.
...
`infra/spire/federation/` (this unit) and `infra/spire/agent/`.

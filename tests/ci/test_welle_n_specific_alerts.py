...
_TAG50_GROUP_CONTRACT = {
    ...
    "welle-4-alerts": (2, 3, "30s"),
    "welle-5-alerts": (2, 3, "30s"),
    "welle-6-alerts": (2, 3, "30s"),
    "welle-7-alerts": (2, 3, "30s"),
}
...
def tag50_alerts_by_name(alerts: dict) -> dict[str, dict]:
    """Alerts strictly inside the welle-N-alerts groups (Tag-50)."""
...
def test_tag50_alert_names_disjoint_from_tag45(
    ...
    # Tag-45 names start with "WakirPhase3" -- Tag-50 starts with
    # "WakirWelle". The two name-prefixes MUST stay disjoint.
    tag45_names = {

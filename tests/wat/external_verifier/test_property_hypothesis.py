...
from wat.anchor.external_verifier import (  # noqa: E402
    AnchorVerification,
    QuorumPolicy,
    PoleResult,
...
from wat.anchor.external_verifier.aggregator import _evaluate_quorum  # noqa: E402
from wat.anchor.external_verifier.poles import _extract_heights_from_text  # noqa: E402

from tests.wat.external_verifier.fixtures import (  # noqa: E402
...
def test_tv_prop_6a_well_formed_ots_bytes_accepted_by_structural_pole(
    ...
    """
    from wat.anchor.external_verifier.poles import pole_python_stdlib_verify
